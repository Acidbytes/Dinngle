...
global $url_pagina_inicial_jogos; // url de pagina inicial
...
$numero_pagina_atual /= $limite_resultados_pagina_jogos; // calcula pagina atual real
...
$numero_paginas = round($numero_resultados / $limite_resultados_pagina_jogos) + 1; // calcula numero de paginas

$numero_paginas_real = round($numero_resultados / $limite_resultados_pagina_jogos); // numero de paginas real
...
$numero_pagina_anterior = ($numero_pagina_atual - 1) * $limite_resultados_pagina_jogos; // numero de pagina anterior

$numero_pagina_proxima = ($numero_pagina_atual + 1) * $limite_resultados_pagina_jogos; // numero de proxima pagina
...
$url_padrao_index = $url_pagina_inicial_jogos."?pesquisa_generica=$pesquisa_generica"; // url padrao de index
