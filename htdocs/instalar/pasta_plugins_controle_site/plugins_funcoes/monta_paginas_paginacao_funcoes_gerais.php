...
$url_padrao_index = $url_pagina_inicial_site."?pesquisa_generica=$pesquisa_generica&tipo_pagina=7&editar_perfil_modo=0&numero_controle=3&tipo_pesquisa_funcoes=$tipo_pesquisa_funcoes"; // url padrao de index
