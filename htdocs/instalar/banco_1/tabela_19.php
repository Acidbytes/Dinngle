...
$nome_de_tabela = $tabela_banco[19]; // nome de tabela
...
$campos .= "legal text, "; // campos da tabela
$campos .= "inteligente text, "; // campos da tabela
$campos .= "bonito text"; // campos da tabela
